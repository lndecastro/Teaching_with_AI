...
|--------|-----------------------------|---------------------------|--------------------------|------------------------|------------------|
| **0. Pedagogical Foundations for Teaching with AI** | **Foundational Layer — Pedagogical Integration** | AI-Augmented Learning, dual-pillar framework, seven pedagogical principles, responsible AI learning design | Principle map, AI-augmented learning model, instructional AI philosophy, course AI usage guidelines | --- | ChatGPT, Claude, Gemini, NotebookLM |
